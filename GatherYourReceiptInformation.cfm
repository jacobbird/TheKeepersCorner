...
<tr>
<td colspan="7"><br />
  <cfinput type="button" name="MakePDF" value="Print - Make PDF - Print" onClick="window.open('https://secure.reliablecleanroomproducts.com/receiptConfirmationPDF.cfm?UUID=#Cookie.OrderNumber#','window1')"></td>
</tr>
<tr>
<td height="61" colspan="7" class="ArialStore">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <cfif structkeyexists(cookie, "UserID") and not cookie.UserID eq ""><cfoutput>Thank You #populateFieldsRet.FirstName# #populateFieldsRet.LastName# You are a #populateFieldsRet.AccessType# Member!  </cfoutput>
  </cfif></td>
</tr>
<tr>
<td width="1"></td>
...
<tr>
<td>&nbsp;</td>
<td colspan="3"><strong>Gather Your Receipt Information:</strong></td>
<td width="256">&nbsp;</td>
</tr>
<tr>
    <td>&nbsp;</td>
    <td colspan="4"><p class="ArialStoreTitle">DiscountSoccerSupply.com - CA</p>      </td>
    <td width="160" valign="top"><p class="ArialStoreTitle">Receipt</p></td>
    <td colspan="2" >&nbsp;</td>
    </tr>
    <tr>
    <td height="72">&nbsp;    </td>
    <td height="72" colspan="2" valign="top"><i>Billing Address</i>
        <br>
    #SelectAll.FirstName# #SelectAll.LastName# <br>
...
#SelectAll.Zip#</td>
    <td height="72">&nbsp;</td>
    <td height="72">&nbsp;</td>
    <td height="72" bordercolor="##999999" valign="top"><br><p><strong>&nbsp;&nbsp;Receipt Date </strong><br>
      &nbsp;&nbsp;#SelectAll.Date#</p>
      <p><strong>&nbsp;&nbsp;Receipt Type: </strong><br>&nbsp;&nbsp;Purchase</p><br></td>
    <td height="72" colspan="3">&nbsp;</td>
    </tr>
  <tr>
    <td width="1" height="76" rowspan="2">&nbsp;</td>
    ...
    <cfset total = (#variables.subtotal# * .0825)+ #variables.subtotal# + #SelectAll.Shipping#>
  <tr>
    <td colspan="8" align="left" valign="top" class="ArialStore">Thank you for using ReliableCleanRoomProducts.com! Your #SelectAll.CCType# card has been charged #dollarformat(variables.total)#. Please keep a copy of this page for you records.</td>
  </tr>
  <tr>
   ...
   <tr>
        ...
        <th width="216" align="left">&nbsp;</th>
      <th width="256" align="left">Quantity</th>
      <th align="left">Unit Price</th>
        ...
        <tr height="20">
          <td colspan="2"></td>
          <td width="214">#ItemNumbers[counter]# #getDescription.ItemName# </td>
      ...
      <tr>
        <td colspan="2"></td>
        <td colspan="2" rowspan="4" valign="top" bordercolor="##999999" class="ArialStore"><p><br>
              <span class="style3">&nbsp;&nbsp;Customer Service</span><br>
  &nbsp;&nbsp; If you have any questions or changes to   <br />
  &nbsp;&nbsp; make about your order please call Reliable<br></p>
     Cleanroom Products at:<br>
            
        <p class="style3 style4">&nbsp; &nbsp;1(909)919-7970</p><br></td>
        <td>&nbsp;&nbsp;Sub-Total:</td>
